...
//#]
    ...
    //## auto_generated
    int getFeutreUsagee() const;
    
    //## auto_generated
    void setFeutreUsagee(int p_feutreUsagee);
    
    //## auto_generated
    int getPasDeFeutre() const;
    
    //## auto_generated
    void setPasDeFeutre(int p_pasDeFeutre);
...
protected :
    ...
    int feutreUsagee;		//## attribute feutreUsagee
    
    int pasDeFeutre;		//## attribute pasDeFeutre
