...
#define repChargementFournitureEchangee_InterfacesPkg_id 24616

#define reqChargementFournitureEchangee_InterfacesPkg_id 24617

#define repEchangeFourniture_InterfacesPkg_id 24618

#define reqEchangeFourniture_InterfacesPkg_id 24619

#define repDechargementNouvelleFourniture_InterfacesPkg_id 24620

#define reqDechargementNouvelleFourniture_InterfacesPkg_id 24621
//#]
...
class repChargementFournitureEchangee : public OMEvent {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedrepChargementFournitureEchangee;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    repChargementFournitureEchangee();
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedrepChargementFournitureEchangee : virtual public AOMEvent {
    DECLARE_META_EVENT(repChargementFournitureEchangee)
};
//#]
#endif // _OMINSTRUMENT

//## event reqChargementFournitureEchangee()
class reqChargementFournitureEchangee : public OMEvent {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedreqChargementFournitureEchangee;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    reqChargementFournitureEchangee();
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedreqChargementFournitureEchangee : virtual public AOMEvent {
    DECLARE_META_EVENT(reqChargementFournitureEchangee)
};
//#]
#endif // _OMINSTRUMENT
...
class repDechargementNouvelleFourniture : public OMEvent {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedrepDechargementNouvelleFourniture;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    repDechargementNouvelleFourniture();
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedrepDechargementNouvelleFourniture : virtual public AOMEvent {
    DECLARE_META_EVENT(repDechargementNouvelleFourniture)
};
//#]
#endif // _OMINSTRUMENT

//## event reqDechargementNouvelleFourniture()
class reqDechargementNouvelleFourniture : public OMEvent {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedreqDechargementNouvelleFourniture;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    reqDechargementNouvelleFourniture();
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedreqDechargementNouvelleFourniture : virtual public AOMEvent {
    DECLARE_META_EVENT(reqDechargementNouvelleFourniture)
};
//#]
#endif // _OMINSTRUMENT
