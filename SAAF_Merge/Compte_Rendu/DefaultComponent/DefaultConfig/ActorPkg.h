...
#define prevenue_ActorPkg_id 5003
//#]
...
//## event prevenue()
class prevenue : public OMEvent {
    ////    Friends    ////
    
public :

#ifdef _OMINSTRUMENT
    friend class OMAnimatedprevenue;
#endif // _OMINSTRUMENT
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedprevenue : virtual public AOMEvent {
    DECLARE_META_EVENT(prevenue)
};
//#]
#endif // _OMINSTRUMENT
