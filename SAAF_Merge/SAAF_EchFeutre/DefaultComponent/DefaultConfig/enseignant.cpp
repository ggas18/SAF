...
int enseignant::getFeutreUsagee() const {
    return feutreUsagee;
}

void enseignant::setFeutreUsagee(int p_feutreUsagee) {
    feutreUsagee = p_feutreUsagee;
}

int enseignant::getPasDeFeutre() const {
    return pasDeFeutre;
}

void enseignant::setPasDeFeutre(int p_pasDeFeutre) {
    pasDeFeutre = p_pasDeFeutre;
}
...
void OMAnimatedenseignant::serializeAttributes(AOMSAttributes* aomsAttributes) const {
    aomsAttributes->addAttribute("pasDeFeutre", x2String(myReal->pasDeFeutre));
    aomsAttributes->addAttribute("feutreUsagee", x2String(myReal->feutreUsagee));
